...
def train(num_classes, batch_size, num_epochs, workspace="./raw", device='cuda', transform=None):
    '''
...
if __name__ == "__main__":
    ...
    if args.action == "train":
        ...
        train(args.num_classes, args.batch_size, args.num_epochs, args.workspace, device=device, transform=tran)
